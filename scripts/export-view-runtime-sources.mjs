...
const sourceFiles = [
  "src/components/view/viewEditorState.ts",
  "src/composables/useWorkspaceEventScope.ts",
  "src/services/debugConsole.ts",
  "src/services/frontendSdk.ts",
  "src/services/frontendWorkbench.ts",
  "src/services/frontendExecution.ts",
  "src/components/view/viewHostRegistry.ts",
  "src/components/view/viewExecutionScope.ts",
  "src/components/view/viewHostApi.ts",
  "src/components/view/viewAutomation.ts",
  "src/components/view/viewCompilation.ts",
  "src/components/view/viewCompilationTypes.ts",
  "src/components/view/viewCompilationCore.ts",
  "src/components/view/viewCompilation.worker.ts",
  "src/components/view/ViewRuntimeHost.vue",
  "src/components/view/viewPackageDiagnostics.ts",
  "src/services/project.ts",
  "src/stores/workspaceContext.ts",
  "src/services/workspaceEventHub.ts",
  ...
  "src/components/link-board/index.ts",
  "src/components/link-board/linkBoardTypes.ts",
  "src/components/link-board/LinkBoard.vue",
  ...
  "src/components/table/serializedTable.ts",
  "src/components/table/SerializedTableView.vue",
  "src/components/icons/LucideIcon.vue",
  "src/components/icons/unityAssetIcons.ts",
  "src/components/asset/AssetTextViewer.vue",
  ...
  "src/components/unity/UnityBoundsField.vue",
  "src/components/unity/UnityColorField.vue",
  "src/components/unity/UnityColorHdrField.vue",
  "src/components/unity/UnityCurveField.vue",
  "src/components/unity/UnityEnumField.vue",
  "src/components/unity/UnityFlagsField.vue",
  "src/components/unity/UnityGradientField.vue",
  ...
  "src/components/unity/unityPropertyBinding.ts",
  "src/components/unity/unityPropertyEditingContext.ts",
  ...
  "src/services/unityAssets.ts",
  "src/services/unityAssetBatch.ts",
  "src/services/unityYamlProperty.ts",
  "src/services/unityPropertyApi.ts",
  "src/services/unityObjectDrawer.ts",
  "src/services/unityObjectReferencePicker.ts",
  "src/services/propertyTree.ts",
  "src/services/unityPropertyPath.ts",
  "src/services/unityValueEditorWindow.ts",
