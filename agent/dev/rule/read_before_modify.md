...
* For complex tasks that require multiple steps, you should use the `todowrite` tool to create a todo list at the beginning of the task, break the work into concrete and verifiable steps, and improve your attention over long tasks. Mark each step complete immediately after finishing it; do not batch-update statuses.
