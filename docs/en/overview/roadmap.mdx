---
title: Roadmap
description: Follow-up development plan for Locus
---
...
- **More Unity-domain knowledge SKILL**: maintain project knowledge bases and memory (`/dream`), create particle systems, actually read profiler data and analyze project performance bottlenecks, write custom render pipelines, and more
