...
| `/garbage-collection` | Reclaim unused space in the session and current project databases, keeping all data |
...
| `/console-error` | Attach only current Unity Console errors |
| `/plan` | Enter plan mode (Unity sessions only) |
