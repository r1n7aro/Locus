---
title: Knowledge
description: What each of the five knowledge types is for, the tree badges, and how to read the overview stats
---
...
- **Plan (execution plans)**: stores task plans, milestones, dependencies, and progress so the Agent can keep track of the next steps across sessions.
...
Maintenance of Design and Memory is covered in [Design and Memory](/en/knowledge/memory-and-design), while Skill and Reference are covered in [Skill and Reference](/en/knowledge/skills-and-references).
