...
export function useSettingsState(emit: SettingsEmit) {
  ...
  // ── Navigation ───────────────────────────────────────────────────────
  const activeCategory = ref<"api" | "models" | "modelUsage" | "permissions" | "mcp" | "mcpServer" | "codeAnalysis" | "hotReload" | "unityConnection" | "testing" | "proxy" | "general" | "display" | "notifications" | "shortcuts" | "globalSearch" | "console" | "about" | "experimental">("general");
