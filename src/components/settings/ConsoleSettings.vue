  ...
  <div class="settings-section">
    ...
    <div class="console-panel">
      <div class="console-toolbar">
        ...
        />
        <button class="action-btn console-action" @click="refreshAll">
          {{ t("common.refresh") }}
        </button>
        <button class="action-btn console-action" @click="clearAll">
      ...
      <div ref="listRef" class="console-list">
        <div class="console-grid" :style="consoleGridStyle">
          ...
          >
            ...
            <span class="console-source">{{ formatSource(entry.source) }}</span>
            <span class="console-module" :title="entry.module">{{ entry.module }}</span>
            <pre class="console-message">{{ entry.message }}</pre>
          </div>
        </div>
      </div>
    </div>
...
.console-row.level-error {
  background: color-mix(in srgb, var(--status-danger-bg) 52%, transparent);
}
