...
describe("unityObjectPreview", () => {
  ...
  it("wires the public components to the shared preview and editor surfaces", () => {
    ...
    expect(viewBindings).toContain("ValidatePropertyTreeObjectTarget");
    expect(viewBindings).toContain("SnapshotSerializedObject");
    expect(viewBindings).toContain("SnapshotPropertyTreeObjectProperties");
    expect(viewBindings).toContain("PropertyTreeComponentTarget");
    expect(viewBindings).toContain("PropertyTreeComponentEnabledPropertyPath");
    expect(viewBindings).toContain("PropertyTreeGameObjectActivePropertyPath");
    expect(viewBindings).toContain("BuildPropertyTreeSyntheticHeaderPropertySnapshot");
    expect(viewBindings).toContain("WritePropertyTreeSyntheticHeaderProperty");
    expect(viewBindings).toContain("TrySetPropertyTreeComponentEnabledState");
    ...
    expect(viewBindings).toContain("IsPropertyTreePreviewMode");
    ...
    expect(viewBindings).not.toContain("QueuePropertyTreeAssetSave");
