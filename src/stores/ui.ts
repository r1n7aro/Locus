...
export const useUiStore = defineStore("ui", () => {
  ...
  const settingsCategoryHint = ref<"api" | "models" | "permissions" | "mcp" | "codeAnalysis" | "hotReload" | "unityConnection" | "testing" | "proxy" | "general" | "display" | "notifications" | "shortcuts" | "archived" | "console" | "about" | null>(null);
